...
const atualizaCessaoDireito = (dados) => {
    ...
    if (dados.custrecord_rsc_erro_perc_cessao_direito) {
        loadReg.setValue('custrecord_rsc_erro_perc_cessao_direito', dados.custrecord_rsc_erro_perc_cessao_direito);
    } 
...
const transferirContrato = (dados) => {
    ...
    try {       
        ...
        console.log('Status.value', dados.custbody_rsc_status_contrato)
        ...
        // atualizaCessaoDireito({id: dados.cessaoDireito});
...
const parcelaUnica = (dados) => {
    ...
    try {
        ...
        var camposFI = {
            ...
            custbody_rsc_indice: lookupContrato.custbody_rsc_indice.lenth > 0 ? lookupContrato.custbody_rsc_indice[0].value : '', // FRAÇÃO PRINCIPAL
            custbody_rsc_data_juros: '',
            // Dados dos Contratos
            custbody_rsc_nrdocboleto: lookupContrato.custbody_rsc_nrdocboleto,
            custbodyrsc_tpparc: 6, // Mensal
